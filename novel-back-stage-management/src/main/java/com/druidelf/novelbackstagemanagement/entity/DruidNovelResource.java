...
public class DruidNovelResource implements Serializable {
     ...
     * 资源链接地址(压缩格式格式)
     */
    @ApiModelProperty("资源链接地址(压缩格式格式)")
     ...
     * txt是否下载 0-否 1-是
     */
    @ApiModelProperty("txt是否下载 0-否 1-是")
     ...
     * 图片是否下载 0-否 1-是
     */
    @ApiModelProperty("图片是否下载 0-否 1-是")
     ...
     * 章节存放地址
     */
    @ApiModelProperty("章节存放地址")
    @Column(name = "chapter_repository_path")
    private String chapterRepositoryPath;

    private static final long serialVersionUID = 6571997330286791388L;
}