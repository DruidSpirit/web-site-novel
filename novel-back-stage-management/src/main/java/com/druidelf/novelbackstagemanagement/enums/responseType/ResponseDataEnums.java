package com.druidelf.novelbackstagemanagement.enums.responseType;
...
public enum ResponseDataEnums implements  ResponseInterface {
    ...
    RESPONSE_DATA_CRAWL_FAIL(50000, "数据爬取批量插入失败"),
    RESPONSE_TXT_LOADDOWN_FAIL(50001, "txt文本小说下载失败"),
    RESPONSE_SRC_LOADDOWN_FAIL(50002, "小说图片下载失败"),
    RESPONSE_RESOURCE_LOADDOWN_FAIL(50003, "小说资源下载失败"),
    RESPONSE_CRAWLER_IS_NOT_EXIST(50004, "爬取的网站还未使用爬虫器分析"),
    RESPONSE_CRAWLER_THREAD_TOO_MANY(50005, "开启线程过多,请谨慎使用线程"),
